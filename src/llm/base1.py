...
from src.constants import END_CODE_TAG, START_CODE_TAG
...
class HuggingFaceLLM(LLM):
    ...
    def query(self, payload):
        ...
        # your local LLM API json format
        # some examples
        ...
        # output = json.loads(response.text)['answer']
    ...
    def call(self, instruction: str, value: str, suffix: str = "") -> str:
        ...
        for _i in range(self._max_retries):
            # response = self.query({"query": payload})
        ...
        # output = str(response).replace(instruction + value + suffix, "")
